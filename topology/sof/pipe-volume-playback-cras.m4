...
# and capabilities modified to meet cras requirements
#
...
#Use min buffer of 20ms and max buffer of 80ms required for youtube playback
PCM_CAPABILITIES(Passthrough Playback PCM_ID, `S32_LE,S24_LE,S16_LE', 48000, 48000, 2, PIPELINE_CHANNELS, 2, 16, 192, 16384, 7680, 30720)
